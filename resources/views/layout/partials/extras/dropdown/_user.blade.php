...
@else
    ...
    <div class="d-flex align-items-center justify-content-between flex-wrap p-8 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url('{{ asset('media/misc/bg-1.jpg') }}')">
        ...
        <span class="label label-success label-lg font-weight-bold label-inline">admin</span>
    </div>
@endif
...
<div class="navi navi-spacer-x-0 pt-5">
    ...
    <div class="navi-footer">
        <form action="{{route('logout')}}" method="POST">
            @csrf
            <button type="submit" target="_blank" class="btn btn-light-primary btn-block font-weight-bold">Sign Out</button>
        </form>
    </div>
</div>
